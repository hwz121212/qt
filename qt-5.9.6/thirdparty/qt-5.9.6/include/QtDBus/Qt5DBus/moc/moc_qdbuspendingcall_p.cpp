...
#include "../../5.9.6/QtDBus/private/qdbuspendingcall_p.h"
...
void QDBusPendingCallWatcherHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusPendingCallWatcherHelper::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusPendingCallWatcherHelper::reply)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusPendingCallWatcherHelper::error)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QDBusPendingCallWatcherHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDBusPendingCallWatcherHelper.data,
      qt_meta_data_QDBusPendingCallWatcherHelper,  qt_static_metacall, nullptr, nullptr}
};
