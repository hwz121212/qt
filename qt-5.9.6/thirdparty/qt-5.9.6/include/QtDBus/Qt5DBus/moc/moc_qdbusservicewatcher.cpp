...
QT_MOC_LITERAL(12, 164, 20), // "WatchForRegistration"
QT_MOC_LITERAL(13, 185, 22), // "WatchForUnregistration"
QT_MOC_LITERAL(14, 208, 19) // "WatchForOwnerChange"
    ...
    "watchMode\0WatchMode\0WatchForRegistration\0"
    "WatchForUnregistration\0WatchForOwnerChange"
};
...
static const uint qt_meta_data_QDBusServiceWatcher[] = {
 ...
 // enum data: key, value
      12, uint(QDBusServiceWatcher::WatchForRegistration),
      13, uint(QDBusServiceWatcher::WatchForUnregistration),
      14, uint(QDBusServiceWatcher::WatchForOwnerChange),
...
void QDBusServiceWatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusServiceWatcher::serviceRegistered)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QDBusServiceWatcher::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusServiceWatcher::serviceUnregistered)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusServiceWatcher::serviceOwnerChanged)) {
                *result = 2;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast<int*>(_v) = QFlag(_t->watchMode()); break;
        default: break;
        }
        ...
        case 1: _t->setWatchMode(QFlag(*reinterpret_cast<int*>(_v))); break;
        default: break;
        }
...
const QMetaObject QDBusServiceWatcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDBusServiceWatcher.data,
      qt_meta_data_QDBusServiceWatcher,  qt_static_metacall, nullptr, nullptr}
};
