...
#include "../../5.9.6/QtDBus/private/qdbusconnectionmanager_p.h"
...
void QDBusConnectionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionManager::connectionRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionManager::serverRequested)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QDBusConnectionManager::staticMetaObject = {
    { &QDaemonThread::staticMetaObject, qt_meta_stringdata_QDBusConnectionManager.data,
      qt_meta_data_QDBusConnectionManager,  qt_static_metacall, nullptr, nullptr}
};
