...
#include "../../5.9.6/QtDBus/private/qdbusconnection_p.h"
...
void QDBusConnectionPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: { bool _r = _t->addSignalHook((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const SignalHook(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
...
const QMetaObject QDBusConnectionPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDBusConnectionPrivate.data,
      qt_meta_data_QDBusConnectionPrivate,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QDBusConnectionDispatchEnabler *_t = static_cast<QDBusConnectionDispatchEnabler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QDBusConnectionDispatchEnabler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDBusConnectionDispatchEnabler.data,
      qt_meta_data_QDBusConnectionDispatchEnabler,  qt_static_metacall, nullptr, nullptr}
};
