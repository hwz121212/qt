...
void QDBusConnectionInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::serviceRegistered)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QDBusConnectionInterface::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::serviceUnregistered)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::serviceOwnerChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::callWithCallbackFailed)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QDBusConnectionInterface::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::NameAcquired)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QDBusConnectionInterface::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::NameLost)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QDBusConnectionInterface::*_t)(const QString & , const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBusConnectionInterface::NameOwnerChanged)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject QDBusConnectionInterface::staticMetaObject = {
    { &QDBusAbstractInterface::staticMetaObject, qt_meta_stringdata_QDBusConnectionInterface.data,
      qt_meta_data_QDBusConnectionInterface,  qt_static_metacall, nullptr, nullptr}
};
