...
void QWinThumbnailToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWinThumbnailToolBar::iconicThumbnailPixmapRequested)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QWinThumbnailToolBar::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWinThumbnailToolBar::iconicLivePreviewPixmapRequested)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QWinThumbnailToolBar::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWinThumbnailToolBar.data,
      qt_meta_data_QWinThumbnailToolBar,  qt_static_metacall, nullptr, nullptr}
};
