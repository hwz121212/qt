...
#include "../../5.9.6/QtNetwork/private/qnetworkfile_p.h"
...
void QNetworkFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QNetworkFile *_t = static_cast<QNetworkFile *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QNetworkFile::*_t)(bool );
        ...
        {
            typedef void (QNetworkFile::*_t)(QNetworkRequest::KnownHeaders , const QVariant & );
        ...
        {
            typedef void (QNetworkFile::*_t)(QNetworkReply::NetworkError , const QString & );
...
const QMetaObject QNetworkFile::staticMetaObject = {
    { &QFile::staticMetaObject, qt_meta_stringdata_QNetworkFile.data,
      qt_meta_data_QNetworkFile,  qt_static_metacall, nullptr, nullptr}
};
