...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGeoRoutingManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGeoRoutingManager_t qt_meta_stringdata_QGeoRoutingManager = {
    {
QT_MOC_LITERAL(0, 0, 18), // "QGeoRoutingManager"
QT_MOC_LITERAL(1, 19, 8), // "finished"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 15), // "QGeoRouteReply*"
QT_MOC_LITERAL(4, 45, 5), // "reply"
QT_MOC_LITERAL(5, 51, 5), // "error"
QT_MOC_LITERAL(6, 57, 21), // "QGeoRouteReply::Error"
...
void QGeoRoutingManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGeoRoutingManager::finished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGeoRoutingManager::error)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QGeoRoutingManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGeoRoutingManager.data,
      qt_meta_data_QGeoRoutingManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *QGeoRoutingManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGeoRoutingManager.stringdata0))
