...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGeoRouteReply_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGeoRouteReply_t qt_meta_stringdata_QGeoRouteReply = {
    {
QT_MOC_LITERAL(0, 0, 14), // "QGeoRouteReply"
QT_MOC_LITERAL(1, 15, 8), // "finished"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "aborted"
QT_MOC_LITERAL(4, 33, 5), // "error"
QT_MOC_LITERAL(5, 39, 21), // "QGeoRouteReply::Error"
QT_MOC_LITERAL(6, 61, 11) // "errorString"

    },
    "QGeoRouteReply\0finished\0\0aborted\0error\0"
    "QGeoRouteReply::Error\0errorString"
};
...
void QGeoRouteReply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->error((*reinterpret_cast< QGeoRouteReply::Error(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 3: _t->error((*reinterpret_cast< QGeoRouteReply::Error(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGeoRouteReply::finished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QGeoRouteReply::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGeoRouteReply::aborted)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGeoRouteReply::error)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QGeoRouteReply::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGeoRouteReply.data,
      qt_meta_data_QGeoRouteReply,  qt_static_metacall, nullptr, nullptr}
};
...
void *QGeoRouteReply::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGeoRouteReply.stringdata0))
