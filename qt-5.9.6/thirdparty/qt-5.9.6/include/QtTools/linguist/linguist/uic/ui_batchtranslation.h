...
public:
    ...
    {
        batchTranslationDialog->setWindowTitle(QApplication::translate("BatchTranslationDialog", "Qt Linguist - Batch Translation", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("BatchTranslationDialog", "Options", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ckMarkFinished->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        ckMarkFinished->setText(QApplication::translate("BatchTranslationDialog", "Set translated entries to finished", Q_NULLPTR));
        ckTranslateTranslated->setText(QApplication::translate("BatchTranslationDialog", "Retranslate entries with existing translation", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ckTranslateFinished->setToolTip(QApplication::translate("BatchTranslationDialog", "Note that the modified entries will be reset to unfinished if 'Set translated entries to finished' above is unchecked", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ckTranslateFinished->setText(QApplication::translate("BatchTranslationDialog", "Translate also finished entries", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("BatchTranslationDialog", "Phrase book preference", Q_NULLPTR));
        moveUpButton->setText(QApplication::translate("BatchTranslationDialog", "Move up", Q_NULLPTR));
        moveDownButton->setText(QApplication::translate("BatchTranslationDialog", "Move down", Q_NULLPTR));
        label->setText(QApplication::translate("BatchTranslationDialog", "The batch translator will search through the selected phrase books in the order given above", Q_NULLPTR));
        runButton->setText(QApplication::translate("BatchTranslationDialog", "&Run", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("BatchTranslationDialog", "Cancel", Q_NULLPTR));
    } // retranslateUi
