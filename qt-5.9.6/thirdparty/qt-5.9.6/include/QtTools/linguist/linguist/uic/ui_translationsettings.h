...
public:
    ...
    void retranslateUi(QDialog *translationSettingsDialog)
    {
        ...
        srcGroupBox->setTitle(QApplication::translate("TranslationSettingsDialog", "Source language", Q_NULLPTR));
        srcLblLanguage->setText(QApplication::translate("TranslationSettingsDialog", "Language", Q_NULLPTR));
        srcLblCountry->setText(QApplication::translate("TranslationSettingsDialog", "Country/Region", Q_NULLPTR));
        tgtGroupBox->setTitle(QApplication::translate("TranslationSettingsDialog", "Target language", Q_NULLPTR));
        tgtLblLanguage->setText(QApplication::translate("TranslationSettingsDialog", "Language", Q_NULLPTR));
        tgtLblCountry->setText(QApplication::translate("TranslationSettingsDialog", "Country/Region", Q_NULLPTR));
    } // retranslateUi
