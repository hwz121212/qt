...
public:
    ...
    void retranslateUi(QDialog *PhraseBookBox)
    {
        ...
        PhraseBookBox->setWhatsThis(QApplication::translate("PhraseBookBox", "This window allows you to add, modify, or delete entries in a phrase book.", Q_NULLPTR));
...
#endif // QT_NO_WHATSTHIS
        newBut->setText(QApplication::translate("PhraseBookBox", "&New Entry", Q_NULLPTR));
#ifndef QT_NO_WHATSTHIS
        removeBut->setWhatsThis(QApplication::translate("PhraseBookBox", "Click here to remove the entry from the phrase book.", Q_NULLPTR));
#endif // QT_NO_WHATSTHIS
        removeBut->setText(QApplication::translate("PhraseBookBox", "&Remove Entry", Q_NULLPTR));
        settingsBut->setText(QApplication::translate("PhraseBookBox", "Settin&gs...", Q_NULLPTR));
#ifndef QT_NO_WHATSTHIS
