...
#ifndef QT_NO_WHATSTHIS
        skipObsolete->setWhatsThis(QApplication::translate("FindDialog", "Obsoleted messages are skipped when checked.", Q_NULLPTR));
#endif // QT_NO_WHATSTHIS
        skipObsolete->setText(QApplication::translate("FindDialog", "Skip &obsolete", Q_NULLPTR));
#ifndef QT_NO_WHATSTHIS
