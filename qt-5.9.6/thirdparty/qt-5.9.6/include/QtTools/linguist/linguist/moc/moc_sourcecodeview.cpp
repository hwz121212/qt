...
struct qt_meta_stringdata_SourceCodeView_t {
    QByteArrayData data[4];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SourceCodeView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SourceCodeView_t qt_meta_stringdata_SourceCodeView = {
    {
QT_MOC_LITERAL(0, 0, 14), // "SourceCodeView"
QT_MOC_LITERAL(1, 15, 12), // "setActivated"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9) // "activated"

    },
    "SourceCodeView\0setActivated\0\0activated"
};
...
const QMetaObject SourceCodeView::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_SourceCodeView.data,
      qt_meta_data_SourceCodeView,  qt_static_metacall, nullptr, nullptr}
};
...
void *SourceCodeView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SourceCodeView.stringdata0))
