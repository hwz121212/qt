...
struct qt_meta_stringdata_FormPreviewView_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FormPreviewView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FormPreviewView_t qt_meta_stringdata_FormPreviewView = {
    {
QT_MOC_LITERAL(0, 0, 15) // "FormPreviewView"
...
const QMetaObject FormPreviewView::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_FormPreviewView.data,
      qt_meta_data_FormPreviewView,  qt_static_metacall, nullptr, nullptr}
};
...
void *FormPreviewView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormPreviewView.stringdata0))
