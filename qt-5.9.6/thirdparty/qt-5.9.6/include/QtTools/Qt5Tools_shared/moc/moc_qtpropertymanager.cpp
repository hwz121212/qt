...
struct qt_meta_stringdata_QtMetaEnumWrapper_t {
    QByteArrayData data[3];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtMetaEnumWrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMetaEnumWrapper_t qt_meta_stringdata_QtMetaEnumWrapper = {
    {
QT_MOC_LITERAL(0, 0, 17), // "QtMetaEnumWrapper"
QT_MOC_LITERAL(1, 18, 6), // "policy"
QT_MOC_LITERAL(2, 25, 19) // "QSizePolicy::Policy"

    },
    "QtMetaEnumWrapper\0policy\0QSizePolicy::Policy"
};
#undef QT_MOC_LITERAL
...
void QtMetaEnumWrapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QtMetaEnumWrapper *_t = static_cast<QtMetaEnumWrapper *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QSizePolicy::Policy*>(_v) = _t->policy(); break;
        default: break;
        }
...
static const QMetaObject * const qt_meta_extradata_QtMetaEnumWrapper[] = {
        &QSizePolicy::staticMetaObject,
    nullptr
};

const QMetaObject QtMetaEnumWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtMetaEnumWrapper.data,
      qt_meta_data_QtMetaEnumWrapper,  qt_static_metacall, qt_meta_extradata_QtMetaEnumWrapper, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_QtMetaEnumWrapper.stringdata0))
        return static_cast<void*>(this);
