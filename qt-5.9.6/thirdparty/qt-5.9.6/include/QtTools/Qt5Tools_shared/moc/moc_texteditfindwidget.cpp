...
struct qt_meta_stringdata_TextEditFindWidget_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TextEditFindWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TextEditFindWidget_t qt_meta_stringdata_TextEditFindWidget = {
    {
QT_MOC_LITERAL(0, 0, 18) // "TextEditFindWidget"
...
const QMetaObject TextEditFindWidget::staticMetaObject = {
    { &AbstractFindWidget::staticMetaObject, qt_meta_stringdata_TextEditFindWidget.data,
      qt_meta_data_TextEditFindWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *TextEditFindWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextEditFindWidget.stringdata0))
