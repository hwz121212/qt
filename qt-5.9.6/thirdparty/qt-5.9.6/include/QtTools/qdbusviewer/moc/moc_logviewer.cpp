...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LogViewer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LogViewer_t qt_meta_stringdata_LogViewer = {
    {
QT_MOC_LITERAL(0, 0, 9) // "LogViewer"
...
const QMetaObject LogViewer::staticMetaObject = {
    { &QTextBrowser::staticMetaObject, qt_meta_stringdata_LogViewer.data,
      qt_meta_data_LogViewer,  qt_static_metacall, nullptr, nullptr}
};
...
void *LogViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LogViewer.stringdata0))
