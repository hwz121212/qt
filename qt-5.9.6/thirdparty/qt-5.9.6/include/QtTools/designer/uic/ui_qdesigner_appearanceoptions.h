...
public:
    ...
    {
        AppearanceOptionsWidget->setWindowTitle(QApplication::translate("AppearanceOptionsWidget", "Form", Q_NULLPTR));
        m_uiModeGroupBox->setTitle(QApplication::translate("AppearanceOptionsWidget", "User Interface Mode", Q_NULLPTR));
    } // retranslateUi
