...
struct qt_meta_stringdata_FilterPage_t {
    QByteArrayData data[4];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FilterPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FilterPage_t qt_meta_stringdata_FilterPage = {
    {
QT_MOC_LITERAL(0, 0, 10), // "FilterPage"
QT_MOC_LITERAL(1, 11, 9), // "addFilter"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12) // "removeFilter"

    },
    "FilterPage\0addFilter\0\0removeFilter"
};
...
const QMetaObject FilterPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_FilterPage.data,
      qt_meta_data_FilterPage,  qt_static_metacall, nullptr, nullptr}
};
...
void *FilterPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FilterPage.stringdata0))
