...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OutputPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OutputPage_t qt_meta_stringdata_OutputPage = {
    {
QT_MOC_LITERAL(0, 0, 10) // "OutputPage"
...
const QMetaObject OutputPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_OutputPage.data,
      qt_meta_data_OutputPage,  qt_static_metacall, nullptr, nullptr}
};
...
void *OutputPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OutputPage.stringdata0))
