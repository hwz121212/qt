...
struct qt_meta_stringdata_FilesPage_t {
    QByteArrayData data[4];
    char stringdata0[37];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FilesPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FilesPage_t qt_meta_stringdata_FilesPage = {
    {
QT_MOC_LITERAL(0, 0, 9), // "FilesPage"
QT_MOC_LITERAL(1, 10, 10), // "removeFile"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14) // "removeAllFiles"

    },
    "FilesPage\0removeFile\0\0removeAllFiles"
};
...
const QMetaObject FilesPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_FilesPage.data,
      qt_meta_data_FilesPage,  qt_static_metacall, nullptr, nullptr}
};
...
void *FilesPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FilesPage.stringdata0))
