...
struct qt_meta_stringdata_InputPage_t {
    QByteArrayData data[3];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_InputPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InputPage_t qt_meta_stringdata_InputPage = {
    {
QT_MOC_LITERAL(0, 0, 9), // "InputPage"
QT_MOC_LITERAL(1, 10, 11), // "getFileName"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "InputPage\0getFileName\0"
};
...
const QMetaObject InputPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_InputPage.data,
      qt_meta_data_InputPage,  qt_static_metacall, nullptr, nullptr}
};
...
void *InputPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InputPage.stringdata0))
