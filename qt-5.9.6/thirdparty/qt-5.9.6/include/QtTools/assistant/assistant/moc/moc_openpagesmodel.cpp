...
struct qt_meta_stringdata_OpenPagesModel_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OpenPagesModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OpenPagesModel_t qt_meta_stringdata_OpenPagesModel = {
    {
QT_MOC_LITERAL(0, 0, 14), // "OpenPagesModel"
QT_MOC_LITERAL(1, 15, 18), // "handleTitleChanged"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "OpenPagesModel\0handleTitleChanged\0"
};
...
const QMetaObject OpenPagesModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_OpenPagesModel.data,
      qt_meta_data_OpenPagesModel,  qt_static_metacall, nullptr, nullptr}
};
...
void *OpenPagesModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpenPagesModel.stringdata0))
