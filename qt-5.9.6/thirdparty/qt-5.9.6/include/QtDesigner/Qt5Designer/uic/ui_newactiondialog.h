...
public:
    ...
    void retranslateUi(QDialog *qdesigner_internal__NewActionDialog)
    {
        ...
        textLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "&Text:", Q_NULLPTR));
        objectNameLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "Object &name:", Q_NULLPTR));
        toolTipLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "T&oolTip:", Q_NULLPTR));
        toolTipToolButton->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "...", Q_NULLPTR));
        iconThemeLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "Icon th&eme:", Q_NULLPTR));
        iconLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "&Icon:", Q_NULLPTR));
        checkableCheckBox->setText(QString());
        checkableLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "&Checkable:", Q_NULLPTR));
        shortcutLabel->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "&Shortcut:", Q_NULLPTR));
        keysequenceResetToolButton->setText(QApplication::translate("qdesigner_internal::NewActionDialog", "...", Q_NULLPTR));
    } // retranslateUi
