...
public:
    ...
    {
        SelectSignalDialog->setWindowTitle(QApplication::translate("SelectSignalDialog", "Go to slot", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("SelectSignalDialog", "Select signal", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = signalList->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("SelectSignalDialog", "class", Q_NULLPTR));
        ___qtreewidgetitem->setText(0, QApplication::translate("SelectSignalDialog", "signal", Q_NULLPTR));
    } // retranslateUi
