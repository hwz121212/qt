...
#include "../../5.9.6/QtDesigner/private/propertylineedit_p.h"
...
struct qt_meta_stringdata_qdesigner_internal__PropertyLineEdit_t {
    QByteArrayData data[3];
    char stringdata0[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__PropertyLineEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__PropertyLineEdit_t qt_meta_stringdata_qdesigner_internal__PropertyLineEdit = {
    {
QT_MOC_LITERAL(0, 0, 36), // "qdesigner_internal::PropertyL..."
QT_MOC_LITERAL(1, 37, 13), // "insertNewLine"
...
const QMetaObject qdesigner_internal::PropertyLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_qdesigner_internal__PropertyLineEdit.data,
      qt_meta_data_qdesigner_internal__PropertyLineEdit,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::PropertyLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__PropertyLineEdit.stringdata0))
