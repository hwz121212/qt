...
struct qt_meta_stringdata_QDesignerWidgetBoxInterface_t {
    QByteArrayData data[1];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QDesignerWidgetBoxInterface_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QDesignerWidgetBoxInterface_t qt_meta_stringdata_QDesignerWidgetBoxInterface = {
    {
QT_MOC_LITERAL(0, 0, 27) // "QDesignerWidgetBoxInterface"
...
const QMetaObject QDesignerWidgetBoxInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QDesignerWidgetBoxInterface.data,
      qt_meta_data_QDesignerWidgetBoxInterface,  qt_static_metacall, nullptr, nullptr}
};
...
void *QDesignerWidgetBoxInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QDesignerWidgetBoxInterface.stringdata0))
