...
struct qt_meta_stringdata_QDesignerFormEditorInterface_t {
    QByteArrayData data[1];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QDesignerFormEditorInterface_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QDesignerFormEditorInterface_t qt_meta_stringdata_QDesignerFormEditorInterface = {
    {
QT_MOC_LITERAL(0, 0, 28) // "QDesignerFormEditorInterface"
...
const QMetaObject QDesignerFormEditorInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDesignerFormEditorInterface.data,
      qt_meta_data_QDesignerFormEditorInterface,  qt_static_metacall, nullptr, nullptr}
};
...
void *QDesignerFormEditorInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QDesignerFormEditorInterface.stringdata0))
