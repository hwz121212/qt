...
#include "../../5.9.6/QtDesigner/private/qdesigner_objectinspector_p.h"
...
struct qt_meta_stringdata_qdesigner_internal__QDesignerObjectInspector_t {
    QByteArrayData data[3];
    char stringdata0[67];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__QDesignerObjectInspector_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__QDesignerObjectInspector_t qt_meta_stringdata_qdesigner_internal__QDesignerObjectInspector = {
    {
QT_MOC_LITERAL(0, 0, 44), // "qdesigner_internal::QDesigner..."
QT_MOC_LITERAL(1, 45, 20), // "mainContainerChanged"
...
const QMetaObject qdesigner_internal::QDesignerObjectInspector::staticMetaObject = {
    { &QDesignerObjectInspectorInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__QDesignerObjectInspector.data,
      qt_meta_data_qdesigner_internal__QDesignerObjectInspector,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::QDesignerObjectInspector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__QDesignerObjectInspector.stringdata0))
