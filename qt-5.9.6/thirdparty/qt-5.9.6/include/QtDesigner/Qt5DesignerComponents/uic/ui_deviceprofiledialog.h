...
public:
    ...
    {
        m_systemFontFamilyLabel->setText(QApplication::translate("DeviceProfileDialog", "&Family", Q_NULLPTR));
        m_systemFontSizeLabel->setText(QApplication::translate("DeviceProfileDialog", "&Point Size", Q_NULLPTR));
        m_styleLabel->setText(QApplication::translate("DeviceProfileDialog", "Style", Q_NULLPTR));
        m_systemDPILabel->setText(QApplication::translate("DeviceProfileDialog", "Device DPI", Q_NULLPTR));
        m_nameLabel->setText(QApplication::translate("DeviceProfileDialog", "Name", Q_NULLPTR));
        Q_UNUSED(dialog);
    } // retranslateUi
