...
struct qt_meta_stringdata_qdesigner_internal__LinePropertySheet_t {
    QByteArrayData data[1];
    char stringdata0[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__LinePropertySheet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__LinePropertySheet_t qt_meta_stringdata_qdesigner_internal__LinePropertySheet = {
    {
QT_MOC_LITERAL(0, 0, 37) // "qdesigner_internal::LinePrope..."
...
const QMetaObject qdesigner_internal::LinePropertySheet::staticMetaObject = {
    { &QDesignerPropertySheet::staticMetaObject, qt_meta_stringdata_qdesigner_internal__LinePropertySheet.data,
      qt_meta_data_qdesigner_internal__LinePropertySheet,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::LinePropertySheet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__LinePropertySheet.stringdata0))
