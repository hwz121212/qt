...
struct qt_meta_stringdata_qdesigner_internal__LayoutPropertySheet_t {
    QByteArrayData data[1];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__LayoutPropertySheet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__LayoutPropertySheet_t qt_meta_stringdata_qdesigner_internal__LayoutPropertySheet = {
    {
QT_MOC_LITERAL(0, 0, 39) // "qdesigner_internal::LayoutPro..."
...
const QMetaObject qdesigner_internal::LayoutPropertySheet::staticMetaObject = {
    { &QDesignerPropertySheet::staticMetaObject, qt_meta_stringdata_qdesigner_internal__LayoutPropertySheet.data,
      qt_meta_data_qdesigner_internal__LayoutPropertySheet,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::LayoutPropertySheet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__LayoutPropertySheet.stringdata0))
