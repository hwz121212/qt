...
struct qt_meta_stringdata_qdesigner_internal__TreeWidgetTaskMenu_t {
    QByteArrayData data[4];
    char stringdata0[66];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__TreeWidgetTaskMenu_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__TreeWidgetTaskMenu_t qt_meta_stringdata_qdesigner_internal__TreeWidgetTaskMenu = {
    {
QT_MOC_LITERAL(0, 0, 38), // "qdesigner_internal::TreeWidge..."
...
const QMetaObject qdesigner_internal::TreeWidgetTaskMenu::staticMetaObject = {
    { &QDesignerTaskMenu::staticMetaObject, qt_meta_stringdata_qdesigner_internal__TreeWidgetTaskMenu.data,
      qt_meta_data_qdesigner_internal__TreeWidgetTaskMenu,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::TreeWidgetTaskMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__TreeWidgetTaskMenu.stringdata0))
