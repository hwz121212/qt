...
struct qt_meta_stringdata_qdesigner_internal__QLayoutWidgetPropertySheet_t {
    QByteArrayData data[1];
    char stringdata0[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__QLayoutWidgetPropertySheet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__QLayoutWidgetPropertySheet_t qt_meta_stringdata_qdesigner_internal__QLayoutWidgetPropertySheet = {
    {
QT_MOC_LITERAL(0, 0, 46) // "qdesigner_internal::QLayoutWi..."
...
const QMetaObject qdesigner_internal::QLayoutWidgetPropertySheet::staticMetaObject = {
    { &QDesignerPropertySheet::staticMetaObject, qt_meta_stringdata_qdesigner_internal__QLayoutWidgetPropertySheet.data,
      qt_meta_data_qdesigner_internal__QLayoutWidgetPropertySheet,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::QLayoutWidgetPropertySheet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__QLayoutWidgetPropertySheet.stringdata0))
