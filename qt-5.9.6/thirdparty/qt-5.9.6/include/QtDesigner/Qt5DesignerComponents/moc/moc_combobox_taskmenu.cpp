...
struct qt_meta_stringdata_qdesigner_internal__ComboBoxTaskMenu_t {
    QByteArrayData data[4];
    char stringdata0[64];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__ComboBoxTaskMenu_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__ComboBoxTaskMenu_t qt_meta_stringdata_qdesigner_internal__ComboBoxTaskMenu = {
    {
QT_MOC_LITERAL(0, 0, 36), // "qdesigner_internal::ComboBoxT..."
QT_MOC_LITERAL(1, 37, 9), // "editItems"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 15) // "updateSelection"
...
const QMetaObject qdesigner_internal::ComboBoxTaskMenu::staticMetaObject = {
    { &QDesignerTaskMenu::staticMetaObject, qt_meta_stringdata_qdesigner_internal__ComboBoxTaskMenu.data,
      qt_meta_data_qdesigner_internal__ComboBoxTaskMenu,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::ComboBoxTaskMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__ComboBoxTaskMenu.stringdata0))
