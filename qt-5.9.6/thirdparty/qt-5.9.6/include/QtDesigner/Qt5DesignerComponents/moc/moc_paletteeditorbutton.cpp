...
struct qt_meta_stringdata_qdesigner_internal__PaletteEditorButton_t {
    QByteArrayData data[6];
    char stringdata0[93];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__PaletteEditorButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__PaletteEditorButton_t qt_meta_stringdata_qdesigner_internal__PaletteEditorButton = {
    {
QT_MOC_LITERAL(0, 0, 39), // "qdesigner_internal::PaletteEd..."
QT_MOC_LITERAL(1, 40, 14), // "paletteChanged"
QT_MOC_LITERAL(2, 55, 0), // ""
QT_MOC_LITERAL(3, 56, 7), // "palette"
QT_MOC_LITERAL(4, 64, 10), // "setPalette"
QT_MOC_LITERAL(5, 75, 17) // "showPaletteEditor"

    },
    "qdesigner_internal::PaletteEditorButton\0"
    "paletteChanged\0\0palette\0setPalette\0"
    "showPaletteEditor"
};
...
void qdesigner_internal::PaletteEditorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PaletteEditorButton::*_t)(const QPalette & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PaletteEditorButton::paletteChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject qdesigner_internal::PaletteEditorButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_qdesigner_internal__PaletteEditorButton.data,
      qt_meta_data_qdesigner_internal__PaletteEditorButton,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::PaletteEditorButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__PaletteEditorButton.stringdata0))
