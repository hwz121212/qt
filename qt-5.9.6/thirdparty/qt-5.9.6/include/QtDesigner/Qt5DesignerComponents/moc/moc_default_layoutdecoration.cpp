...
struct qt_meta_stringdata_qdesigner_internal__QDesignerLayoutDecorationFactory_t {
    QByteArrayData data[1];
    char stringdata0[53];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__QDesignerLayoutDecorationFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__QDesignerLayoutDecorationFactory_t qt_meta_stringdata_qdesigner_internal__QDesignerLayoutDecorationFactory = {
    {
QT_MOC_LITERAL(0, 0, 52) // "qdesigner_internal::QDesigner..."
...
const QMetaObject qdesigner_internal::QDesignerLayoutDecorationFactory::staticMetaObject = {
    { &QExtensionFactory::staticMetaObject, qt_meta_stringdata_qdesigner_internal__QDesignerLayoutDecorationFactory.data,
      qt_meta_data_qdesigner_internal__QDesignerLayoutDecorationFactory,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::QDesignerLayoutDecorationFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__QDesignerLayoutDecorationFactory.stringdata0))
