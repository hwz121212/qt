...
struct qt_meta_stringdata_qdesigner_internal__QMainWindowContainer_t {
    QByteArrayData data[1];
    char stringdata0[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qdesigner_internal__QMainWindowContainer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qdesigner_internal__QMainWindowContainer_t qt_meta_stringdata_qdesigner_internal__QMainWindowContainer = {
    {
QT_MOC_LITERAL(0, 0, 40) // "qdesigner_internal::QMainWind..."
...
const QMetaObject qdesigner_internal::QMainWindowContainer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__QMainWindowContainer.data,
      qt_meta_data_qdesigner_internal__QMainWindowContainer,  qt_static_metacall, nullptr, nullptr}
};
...
void *qdesigner_internal::QMainWindowContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__QMainWindowContainer.stringdata0))
