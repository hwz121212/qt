...
struct qt_meta_stringdata_QSvgWidget_t {
    QByteArrayData data[5];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QSvgWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSvgWidget_t qt_meta_stringdata_QSvgWidget = {
    {
QT_MOC_LITERAL(0, 0, 10), // "QSvgWidget"
QT_MOC_LITERAL(1, 11, 4), // "load"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "file"
QT_MOC_LITERAL(4, 22, 8) // "contents"

    },
    "QSvgWidget\0load\0\0file\0contents"
};
...
const QMetaObject QSvgWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QSvgWidget.data,
      qt_meta_data_QSvgWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *QSvgWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSvgWidget.stringdata0))
