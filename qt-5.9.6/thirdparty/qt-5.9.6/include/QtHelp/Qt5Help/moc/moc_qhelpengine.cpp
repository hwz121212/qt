...
struct qt_meta_stringdata_QHelpEngine_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHelpEngine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QHelpEngine_t qt_meta_stringdata_QHelpEngine = {
    {
QT_MOC_LITERAL(0, 0, 11) // "QHelpEngine"
...
const QMetaObject QHelpEngine::staticMetaObject = {
    { &QHelpEngineCore::staticMetaObject, qt_meta_stringdata_QHelpEngine.data,
      qt_meta_data_QHelpEngine,  qt_static_metacall, nullptr, nullptr}
};
...
void *QHelpEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QHelpEngine.stringdata0))
