...
void QtCharts::QHBarModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHBarModelMapper::seriesReplaced)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QHBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHBarModelMapper::modelReplaced)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QHBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHBarModelMapper::firstBarSetRowChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QHBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHBarModelMapper::lastBarSetRowChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QHBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHBarModelMapper::firstColumnChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QHBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHBarModelMapper::columnCountChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QHBarModelMapper::staticMetaObject = {
    { &QBarModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QHBarModelMapper.data,
      qt_meta_data_QtCharts__QHBarModelMapper,  qt_static_metacall, nullptr, nullptr}
};
