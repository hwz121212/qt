...
void QSGAbstractRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QSGAbstractRenderer *_t = static_cast<QSGAbstractRenderer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QSGAbstractRenderer::*_t)();
...
const QMetaObject QSGAbstractRenderer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QSGAbstractRenderer.data,
      qt_meta_data_QSGAbstractRenderer,  qt_static_metacall, nullptr, nullptr}
};
