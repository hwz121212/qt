...
#include "../../5.9.6/QtQuick/private/qquicksmoothedanimation_p_p.h"
...
void QSmoothedAnimationTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QSmoothedAnimationTimer *_t = static_cast<QSmoothedAnimationTimer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QSmoothedAnimationTimer::staticMetaObject = {
    { &QTimer::staticMetaObject, qt_meta_stringdata_QSmoothedAnimationTimer.data,
      qt_meta_data_QSmoothedAnimationTimer,  qt_static_metacall, nullptr, nullptr}
};
