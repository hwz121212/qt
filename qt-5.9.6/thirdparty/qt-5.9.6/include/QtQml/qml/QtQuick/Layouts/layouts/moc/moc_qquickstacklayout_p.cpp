...
void QQuickStackLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QQuickStackLayout *_t = static_cast<QQuickStackLayout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QQuickStackLayout::*_t)();
...
const QMetaObject QQuickStackLayout::staticMetaObject = {
    { &QQuickLayout::staticMetaObject, qt_meta_stringdata_QQuickStackLayout.data,
      qt_meta_data_QQuickStackLayout,  qt_static_metacall, nullptr, nullptr}
};
