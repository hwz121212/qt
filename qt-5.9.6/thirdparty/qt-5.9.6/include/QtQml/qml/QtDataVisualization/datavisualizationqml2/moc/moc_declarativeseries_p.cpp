...
void QtDataVisualization::DeclarativeBar3DSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeclarativeBar3DSeries *_t = static_cast<DeclarativeBar3DSeries *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DeclarativeBar3DSeries::*_t)(QPointF );
        ...
        {
            typedef void (DeclarativeBar3DSeries::*_t)(ColorGradient * );
...
const QMetaObject QtDataVisualization::DeclarativeBar3DSeries::staticMetaObject = {
    { &QBar3DSeries::staticMetaObject, qt_meta_stringdata_QtDataVisualization__DeclarativeBar3DSeries.data,
      qt_meta_data_QtDataVisualization__DeclarativeBar3DSeries,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeclarativeScatter3DSeries *_t = static_cast<DeclarativeScatter3DSeries *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DeclarativeScatter3DSeries::*_t)(ColorGradient * );
...
const QMetaObject QtDataVisualization::DeclarativeScatter3DSeries::staticMetaObject = {
    { &QScatter3DSeries::staticMetaObject, qt_meta_stringdata_QtDataVisualization__DeclarativeScatter3DSeries.data,
      qt_meta_data_QtDataVisualization__DeclarativeScatter3DSeries,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeclarativeSurface3DSeries *_t = static_cast<DeclarativeSurface3DSeries *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DeclarativeSurface3DSeries::*_t)(QPointF );
        ...
        {
            typedef void (DeclarativeSurface3DSeries::*_t)(ColorGradient * );
...
const QMetaObject QtDataVisualization::DeclarativeSurface3DSeries::staticMetaObject = {
    { &QSurface3DSeries::staticMetaObject, qt_meta_stringdata_QtDataVisualization__DeclarativeSurface3DSeries.data,
      qt_meta_data_QtDataVisualization__DeclarativeSurface3DSeries,  qt_static_metacall, nullptr, nullptr}
};
