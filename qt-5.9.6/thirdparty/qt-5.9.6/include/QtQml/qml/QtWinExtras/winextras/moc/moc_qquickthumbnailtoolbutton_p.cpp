...
void QQuickThumbnailToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::iconSourceChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::tooltipChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::enabledChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::interactiveChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::visibleChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::dismissOnClickChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QQuickThumbnailToolButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickThumbnailToolButton::flatChanged)) {
                *result = 7;
                return;
            }
        }
...
const QMetaObject QQuickThumbnailToolButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QQuickThumbnailToolButton.data,
      qt_meta_data_QQuickThumbnailToolButton,  qt_static_metacall, nullptr, nullptr}
};
