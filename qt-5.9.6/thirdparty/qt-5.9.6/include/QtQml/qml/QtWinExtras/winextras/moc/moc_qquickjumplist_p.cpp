...
void QQuickJumpList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickJumpList::tasksChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QQuickJumpList::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickJumpList::categoriesChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QQuickJumpList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QQuickJumpList.data,
      qt_meta_data_QQuickJumpList,  qt_static_metacall, nullptr, nullptr}
};
