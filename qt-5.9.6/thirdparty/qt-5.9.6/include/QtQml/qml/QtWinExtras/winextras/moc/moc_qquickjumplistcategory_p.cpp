...
void QQuickJumpListCategory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickJumpListCategory::itemsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QQuickJumpListCategory::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickJumpListCategory::titleChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QQuickJumpListCategory::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickJumpListCategory::visibilityChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QQuickJumpListCategory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QQuickJumpListCategory.data,
      qt_meta_data_QQuickJumpListCategory,  qt_static_metacall, nullptr, nullptr}
};
