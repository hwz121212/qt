...
public:
    ...
    {
        Properties->setWindowTitle(QApplication::translate("Properties", "Form", Q_NULLPTR));
        label_3->setText(QApplication::translate("Properties", "Duration", Q_NULLPTR));
        label->setText(QApplication::translate("Properties", "Code", Q_NULLPTR));
        label_2->setText(QApplication::translate("Properties", "Presets", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("Properties", "Control Points", Q_NULLPTR));
        importButton->setText(QApplication::translate("Properties", "Import AfterEffects Curve", Q_NULLPTR));
    } // retranslateUi
