...
public:
    ...
    {
        Pane->setWindowTitle(QApplication::translate("Pane", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("Pane", "p1", Q_NULLPTR));
        label_x->setText(QApplication::translate("Pane", "x", Q_NULLPTR));
        label_y->setText(QApplication::translate("Pane", "y", Q_NULLPTR));
        smooth->setText(QApplication::translate("Pane", "smooth", Q_NULLPTR));
    } // retranslateUi
