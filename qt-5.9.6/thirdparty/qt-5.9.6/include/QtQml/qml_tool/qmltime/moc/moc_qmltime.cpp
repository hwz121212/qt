/****************************************************************************
** Meta object code from reading C++ file 'qmltime.h'
**
...
#error "The header file 'qmltime.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 6, 9), // "component"
QT_MOC_LITERAL(2, 16, 14) // "QQmlComponent*"

    },
    "Timer\0component\0QQmlComponent*"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QQmlComponent**>(_v) = _t->component(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setComponent(*reinterpret_cast< QQmlComponent**>(_v)); break;
        default: break;
        }
