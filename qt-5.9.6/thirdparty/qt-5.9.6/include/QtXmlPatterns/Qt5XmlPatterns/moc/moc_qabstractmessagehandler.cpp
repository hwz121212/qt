...
struct qt_meta_stringdata_QAbstractMessageHandler_t {
    QByteArrayData data[1];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractMessageHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QAbstractMessageHandler_t qt_meta_stringdata_QAbstractMessageHandler = {
    {
QT_MOC_LITERAL(0, 0, 23) // "QAbstractMessageHandler"
...
const QMetaObject QAbstractMessageHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractMessageHandler.data,
      qt_meta_data_QAbstractMessageHandler,  qt_static_metacall, nullptr, nullptr}
};
...
void *QAbstractMessageHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractMessageHandler.stringdata0))
