...
struct qt_meta_stringdata_QAbstractUriResolver_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractUriResolver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QAbstractUriResolver_t qt_meta_stringdata_QAbstractUriResolver = {
    {
QT_MOC_LITERAL(0, 0, 20) // "QAbstractUriResolver"
...
const QMetaObject QAbstractUriResolver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractUriResolver.data,
      qt_meta_data_QAbstractUriResolver,  qt_static_metacall, nullptr, nullptr}
};
...
void *QAbstractUriResolver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractUriResolver.stringdata0))
