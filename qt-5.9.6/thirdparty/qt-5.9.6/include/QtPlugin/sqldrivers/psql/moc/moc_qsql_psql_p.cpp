...
struct qt_meta_stringdata_QPSQLDriver_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPSQLDriver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QPSQLDriver_t qt_meta_stringdata_QPSQLDriver = {
    {
QT_MOC_LITERAL(0, 0, 11), // "QPSQLDriver"
QT_MOC_LITERAL(1, 12, 21), // "_q_handleNotification"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "QPSQLDriver\0_q_handleNotification\0"
};
...
void QPSQLDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->_q_handleNotification((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject QPSQLDriver::staticMetaObject = {
    { &QSqlDriver::staticMetaObject, qt_meta_stringdata_QPSQLDriver.data,
      qt_meta_data_QPSQLDriver,  qt_static_metacall, nullptr, nullptr}
};
...
void *QPSQLDriver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPSQLDriver.stringdata0))
