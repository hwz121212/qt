...
void QIBusInputContextProxy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::CommitText)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::CursorDownLookupTable)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::CursorUpLookupTable)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::DeleteSurroundingText)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::Disabled)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::Enabled)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::ForwardKeyEvent)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::HideAuxiliaryText)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::HideLookupTable)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::HidePreeditText)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::PageDownLookupTable)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::PageUpLookupTable)) {
                *result = 11;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)(const QDBusVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::RegisterProperties)) {
                *result = 12;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::RequireSurroundingText)) {
                *result = 13;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::ShowAuxiliaryText)) {
                *result = 14;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::ShowLookupTable)) {
                *result = 15;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::ShowPreeditText)) {
                *result = 16;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::UpdateAuxiliaryText)) {
                *result = 17;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)(const QDBusVariant & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::UpdateLookupTable)) {
                *result = 18;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::UpdatePreeditText)) {
                *result = 19;
                return;
            }
        }
        {
            typedef void (QIBusInputContextProxy::*_t)(const QDBusVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QIBusInputContextProxy::UpdateProperty)) {
                *result = 20;
                return;
            }
        }
...
const QMetaObject QIBusInputContextProxy::staticMetaObject = {
    { &QDBusAbstractInterface::staticMetaObject, qt_meta_stringdata_QIBusInputContextProxy.data,
      qt_meta_data_QIBusInputContextProxy,  qt_static_metacall, nullptr, nullptr}
};
