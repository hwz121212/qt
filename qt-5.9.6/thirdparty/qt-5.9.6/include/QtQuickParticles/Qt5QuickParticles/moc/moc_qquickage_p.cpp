...
#include "../../5.9.6/QtQuickParticles/private/qquickage_p.h"
...
void QQuickAgeAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QQuickAgeAffector *_t = static_cast<QQuickAgeAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QQuickAgeAffector::*_t)(int );
        ...
        {
            typedef void (QQuickAgeAffector::*_t)(bool );
...
const QMetaObject QQuickAgeAffector::staticMetaObject = {
    { &QQuickParticleAffector::staticMetaObject, qt_meta_stringdata_QQuickAgeAffector.data,
      qt_meta_data_QQuickAgeAffector,  qt_static_metacall, nullptr, nullptr}
};
