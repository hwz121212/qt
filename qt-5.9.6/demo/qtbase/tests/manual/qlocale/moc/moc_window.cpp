...
static const uint qt_meta_data_Window[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QLocale,    2,
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Window::*_t)(QLocale );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::localeChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Window::localeChanged(QLocale _t1)
{
