...
public:
    ...
    {
        SessionWidget->setWindowTitle(QApplication::translate("SessionWidget", "Session Details", Q_NULLPTR));
        sessionIdLabel->setText(QApplication::translate("SessionWidget", "Session ID:", Q_NULLPTR));
        sessionId->setText(QString());
        sessionStateLabel->setText(QApplication::translate("SessionWidget", "Session State:", Q_NULLPTR));
        sessionState->setText(QApplication::translate("SessionWidget", "Invalid", Q_NULLPTR));
        configurationLabel->setText(QApplication::translate("SessionWidget", "Configuration:", Q_NULLPTR));
        configuration->setText(QString());
        bearerLabel->setText(QApplication::translate("SessionWidget", "Bearer:", Q_NULLPTR));
        bearer->setText(QString());
        interfaceNameLabel->setText(QApplication::translate("SessionWidget", "Interface Name:", Q_NULLPTR));
        interfaceName->setText(QString());
        interfaceGuidLabel->setText(QApplication::translate("SessionWidget", "Interface GUID:", Q_NULLPTR));
        interfaceGuid->setText(QString());
        lastErrorLabel->setText(QApplication::translate("SessionWidget", "Last Error:", Q_NULLPTR));
        lastError->setText(QString());
        errorStringLabel->setText(QApplication::translate("SessionWidget", "Error String:", Q_NULLPTR));
        errorString->setText(QString());
        rxData->setText(QApplication::translate("SessionWidget", "0", Q_NULLPTR));
        txData->setText(QApplication::translate("SessionWidget", "0", Q_NULLPTR));
        label_3->setText(QApplication::translate("SessionWidget", "Active Time:", Q_NULLPTR));
        activeTime->setText(QApplication::translate("SessionWidget", "0 seconds", Q_NULLPTR));
        openSessionButton->setText(QApplication::translate("SessionWidget", "Open", Q_NULLPTR));
        openSyncSessionButton->setText(QApplication::translate("SessionWidget", "Blocking Open", Q_NULLPTR));
        closeSessionButton->setText(QApplication::translate("SessionWidget", "Close", Q_NULLPTR));
        stopSessionButton->setText(QApplication::translate("SessionWidget", "Stop", Q_NULLPTR));
    } // retranslateUi
