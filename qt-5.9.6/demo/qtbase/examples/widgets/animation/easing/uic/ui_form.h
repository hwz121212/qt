...
public:
    ...
    {
        Form->setWindowTitle(QApplication::translate("Form", "Easing curves", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("Form", "Path type", Q_NULLPTR));
        lineRadio->setText(QApplication::translate("Form", "Line", Q_NULLPTR));
        circleRadio->setText(QApplication::translate("Form", "Circle", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("Form", "Properties", Q_NULLPTR));
        label->setText(QApplication::translate("Form", "Period", Q_NULLPTR));
        label_3->setText(QApplication::translate("Form", "Overshoot", Q_NULLPTR));
        label_2->setText(QApplication::translate("Form", "Amplitude", Q_NULLPTR));
    } // retranslateUi
