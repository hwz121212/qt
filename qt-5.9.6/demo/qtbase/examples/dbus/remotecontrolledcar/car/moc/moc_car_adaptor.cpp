...
void CarInterfaceAdaptor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CarInterfaceAdaptor *_t = static_cast<CarInterfaceAdaptor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CarInterfaceAdaptor::*_t)();
...
const QMetaObject CarInterfaceAdaptor::staticMetaObject = {
    { &QDBusAbstractAdaptor::staticMetaObject, qt_meta_stringdata_CarInterfaceAdaptor.data,
      qt_meta_data_CarInterfaceAdaptor,  qt_static_metacall, nullptr, nullptr}
};
