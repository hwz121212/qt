...
void OrbitTransformController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OrbitTransformController *_t = static_cast<OrbitTransformController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (OrbitTransformController::*_t)();
...
const QMetaObject OrbitTransformController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OrbitTransformController.data,
      qt_meta_data_OrbitTransformController,  qt_static_metacall, nullptr, nullptr}
};
