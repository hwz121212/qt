#ifndef REP_LOCALDATACENTER_REPLICA_H
#define REP_LOCALDATACENTER_REPLICA_H
...
class LocalDataCenterReplica : public QRemoteObjectReplica
{
    Q_OBJECT
...
public:
    LocalDataCenterReplica() : QRemoteObjectReplica() { initialize(); }
...
private:
    LocalDataCenterReplica(QRemoteObjectNode *node, const QString &name = QString())
        : QRemoteObjectReplica(ConstructWithNode)
        { initializeNode(node, name); }

    void initialize()
    {
        LocalDataCenterReplica::registerMetatypes();
...
public:
    virtual ~LocalDataCenterReplica() {}
...
public Q_SLOTS:
    ...
    {
        static int __repc_index = LocalDataCenterReplica::staticMetaObject.indexOfSlot("pushData1(int)");
    ...
    {
        static int __repc_index = LocalDataCenterReplica::staticMetaObject.indexOfSlot("pushData2(float)");
        QVariantList __repc_args;
    ...
    {
        static int __repc_index = LocalDataCenterReplica::staticMetaObject.indexOfSlot("pushData3(QString)");
        QVariantList __repc_args;
    ...
    {
        static int __repc_index = LocalDataCenterReplica::staticMetaObject.indexOfSlot("pushData4(QVector<int>)");
        QVariantList __repc_args;
...
#endif // REP_LOCALDATACENTER_REPLICA_H
