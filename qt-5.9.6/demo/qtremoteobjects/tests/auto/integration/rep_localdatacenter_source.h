#ifndef REP_LOCALDATACENTER_SOURCE_H
#define REP_LOCALDATACENTER_SOURCE_H
...
class LocalDataCenterSource : public QObject
{
    Q_OBJECT
    Q_CLASSINFO(QCLASSINFO_REMOTEOBJECT_TYPE, "LocalDataCenter")
    Q_CLASSINFO(QCLASSINFO_REMOTEOBJECT_SIGNATURE, "d811753f10a2fa083dd21422827185fe466ab8b4")
...
public:
    explicit LocalDataCenterSource(QObject *parent = nullptr) : QObject(parent)
    {
...
class LocalDataCenterSimpleSource : public QObject
{
    Q_OBJECT
    Q_CLASSINFO(QCLASSINFO_REMOTEOBJECT_TYPE, "LocalDataCenter")
    Q_CLASSINFO(QCLASSINFO_REMOTEOBJECT_SIGNATURE, "d811753f10a2fa083dd21422827185fe466ab8b4")
...
public:
    explicit LocalDataCenterSimpleSource(QObject *parent = nullptr) : QObject(parent)
        , _data1()
        , _data2()
        , _data3()
        , _data4()
...
public:
    virtual ~LocalDataCenterSimpleSource() {}
...
struct LocalDataCenterSourceAPI : public SourceApiMap
{
    LocalDataCenterSourceAPI(ObjectType *object)
        : SourceApiMap()
    {
        Q_UNUSED(object);
        _properties[0] = 4;
        ...
        _signals[5] = qtro_signal_index<ObjectType>(&ObjectType::callMe, static_cast<void (QObject::*)(QVector<int>)>(0),signalArgCount+0,&signalArgTypes[0]);
        _methods[0] = 4;
    ...
    QString name() const override { return QStringLiteral("LocalDataCenter"); }
    QString typeName() const override { return QStringLiteral("LocalDataCenter"); }
    ...
    const QByteArray signalSignature(int index) const override
    {
        ...
        case 4: return QByteArrayLiteral("callMe(QVector<int>)");
        }
    ...
    QByteArray objectSignature() const override { return QByteArray{"d811753f10a2fa083dd21422827185fe466ab8b4"}; }
...
#endif // REP_LOCALDATACENTER_SOURCE_H
