...
const QMetaObject Speedometer::staticMetaObject = {
    { &SpeedometerSimpleSource::staticMetaObject, qt_meta_stringdata_Speedometer.data,
      qt_meta_data_Speedometer,  qt_static_metacall, nullptr, nullptr}
};
...
void *Speedometer::qt_metacast(const char *_clname)
{
    ...
    return SpeedometerSimpleSource::qt_metacast(_clname);
}

int Speedometer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SpeedometerSimpleSource::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
