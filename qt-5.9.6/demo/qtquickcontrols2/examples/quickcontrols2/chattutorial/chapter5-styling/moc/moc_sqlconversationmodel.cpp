...
void SqlConversationModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SqlConversationModel *_t = static_cast<SqlConversationModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SqlConversationModel::*_t)();
...
const QMetaObject SqlConversationModel::staticMetaObject = {
    { &QSqlTableModel::staticMetaObject, qt_meta_stringdata_SqlConversationModel.data,
      qt_meta_data_SqlConversationModel,  qt_static_metacall, nullptr, nullptr}
};
