...
struct qt_meta_stringdata_WateringConfigDialog_t {
    QByteArrayData data[6];
    char stringdata0[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WateringConfigDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WateringConfigDialog_t qt_meta_stringdata_WateringConfigDialog = {
    {
QT_MOC_LITERAL(0, 0, 20), // "WateringConfigDialog"
QT_MOC_LITERAL(1, 21, 12), // "focusChanged"
...
QT_MOC_LITERAL(5, 48, 3) // "now"
    ...
    "WateringConfigDialog\0focusChanged\0\0"
    "QWidget*\0old\0now"
};
...
const QMetaObject WateringConfigDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_WateringConfigDialog.data,
      qt_meta_data_WateringConfigDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *WateringConfigDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WateringConfigDialog.stringdata0))
