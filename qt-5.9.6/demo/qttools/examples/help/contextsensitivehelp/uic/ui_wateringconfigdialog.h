...
#ifndef UI_WATERINGCONFIGDIALOG_H
#define UI_WATERINGCONFIGDIALOG_H
...
public:
    ...
    void retranslateUi(QDialog *WateringConfigDialog)
    {
        ...
        sourceComboBox->insertItems(0, QStringList()
         << QApplication::translate("WateringConfigDialog", "Fountain", Q_NULLPTR)
...
#endif // UI_WATERINGCONFIGDIALOG_H
