...
struct qt_meta_stringdata_TicTacToeTaskMenu_t {
    QByteArrayData data[3];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TicTacToeTaskMenu_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TicTacToeTaskMenu_t qt_meta_stringdata_TicTacToeTaskMenu = {
    {
QT_MOC_LITERAL(0, 0, 17), // "TicTacToeTaskMenu"
QT_MOC_LITERAL(1, 18, 9), // "editState"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "TicTacToeTaskMenu\0editState\0"
};
...
const QMetaObject TicTacToeTaskMenu::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TicTacToeTaskMenu.data,
      qt_meta_data_TicTacToeTaskMenu,  qt_static_metacall, nullptr, nullptr}
};
...
void *TicTacToeTaskMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TicTacToeTaskMenu.stringdata0))
...
struct qt_meta_stringdata_TicTacToeTaskMenuFactory_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TicTacToeTaskMenuFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TicTacToeTaskMenuFactory_t qt_meta_stringdata_TicTacToeTaskMenuFactory = {
    {
QT_MOC_LITERAL(0, 0, 24) // "TicTacToeTaskMenuFactory"
...
const QMetaObject TicTacToeTaskMenuFactory::staticMetaObject = {
    { &QExtensionFactory::staticMetaObject, qt_meta_stringdata_TicTacToeTaskMenuFactory.data,
      qt_meta_data_TicTacToeTaskMenuFactory,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_TicTacToeTaskMenuFactory.stringdata0))
        return static_cast<void*>(this);
