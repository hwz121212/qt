/****************************************************************************
** Meta object code from reading C++ file 'testwebchannel.h'
**
...
#error "The header file 'testwebchannel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 12), // "clientIsIdle"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "TestWebChannel\0clientIsIdle\0"
};
...
void TestWebChannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->clientIsIdle();
...
const QMetaObject TestWebChannel::staticMetaObject = {
    { &QQmlWebChannel::staticMetaObject, qt_meta_stringdata_TestWebChannel.data,
