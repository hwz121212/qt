...
struct qt_meta_stringdata_SvgTextObject_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SvgTextObject_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SvgTextObject_t qt_meta_stringdata_SvgTextObject = {
    {
QT_MOC_LITERAL(0, 0, 13) // "SvgTextObject"
...
const QMetaObject SvgTextObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SvgTextObject.data,
      qt_meta_data_SvgTextObject,  qt_static_metacall, nullptr, nullptr}
};
...
void *SvgTextObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SvgTextObject.stringdata0))
