...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MimeData_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MimeData_t qt_meta_stringdata_MimeData = {
    {
QT_MOC_LITERAL(0, 0, 8), // "MimeData"
QT_MOC_LITERAL(1, 9, 13), // "dataRequested"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8) // "mimeType"

    },
    "MimeData\0dataRequested\0\0mimeType"
};
...
void MimeData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MimeData::*_t)(const QString & ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MimeData::dataRequested)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MimeData::staticMetaObject = {
    { &QMimeData::staticMetaObject, qt_meta_stringdata_MimeData.data,
      qt_meta_data_MimeData,  qt_static_metacall, nullptr, nullptr}
};
...
void *MimeData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MimeData.stringdata0))
