...
QT_MOC_LITERAL(3, 25, 13) // "slideInterval"

    },
    "SlideShow\0inputReceived\0\0slideInterval"
};
...
void SlideShow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SlideShow::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SlideShow::inputReceived)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->slideInterval(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setSlideInterval(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
const QMetaObject SlideShow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SlideShow.data,
      qt_meta_data_SlideShow,  qt_static_metacall, nullptr, nullptr}
};
