...
QT_MOC_LITERAL(5, 57, 15), // "processFinished"
QT_MOC_LITERAL(6, 73, 8), // "exitCode"
QT_MOC_LITERAL(7, 82, 20), // "QProcess::ExitStatus"
QT_MOC_LITERAL(8, 103, 10), // "exitStatus"
QT_MOC_LITERAL(9, 114, 12), // "processError"
QT_MOC_LITERAL(10, 127, 22), // "QProcess::ProcessError"
QT_MOC_LITERAL(11, 150, 3) // "err"
...
void DemoApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DemoApplication::demoStarted)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DemoApplication::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DemoApplication::demoFinished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject DemoApplication::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DemoApplication.data,
      qt_meta_data_DemoApplication,  qt_static_metacall, nullptr, nullptr}
};
