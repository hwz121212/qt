...
static QUrl abstractURI()
{
    QUrl baseURI;
    QUrl relative;
#include "src_xmlpatterns_api_qabstracturiresolver.cpp"
}
...
#include "src_xmlpatterns_api_qsimplexmlnodemodel.cpp"
...
#include "src_xmlpatterns_api_qabstractxmlforwarditerator.cpp"
};

#include "src_xmlpatterns_api_qxmlname.cpp"
...
void tst_PatternistExamples::buildSnippets() const
{
    ...
    {
#include "src_xmlpatterns_api_qxmlresultitems.cpp"
    }
...
#include "src_xmlpatterns_api_qxmlformatter.cpp"
    }

    {
        QIODevice *myOutputDevice = 0;
#include "src_xmlpatterns_api_qxmlserializer.cpp"
    }
...
#include "src_xmlpatterns_api_qabstractxmlnodemodel.cpp"
    }
    ...
    {
        QIODevice *myOutputDevice = 0;
#include "src_xmlpatterns_api_qabstractxmlreceiver.cpp"
    }

    {
        ...
        QString localName;
        QVariant value;
#include "src_xmlpatterns_api_qxmlquery.cpp"
    }
}
