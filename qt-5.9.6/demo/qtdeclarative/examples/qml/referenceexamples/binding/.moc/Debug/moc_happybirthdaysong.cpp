...
QT_MOC_LITERAL(3, 31, 7), // "advance"
QT_MOC_LITERAL(4, 39, 4) // "name"

    },
    "HappyBirthdaySong\0nameChanged\0\0advance\0"
    "name"
};
...
void HappyBirthdaySong::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (HappyBirthdaySong::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HappyBirthdaySong::nameChanged)) {
                *result = 0;
                return;
            }
        }
