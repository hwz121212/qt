...
void FtpControlChannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpControlChannel::opened)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpControlChannel::closed)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpControlChannel::info)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpControlChannel::reply)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (FtpControlChannel::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpControlChannel::invalidReply)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject FtpControlChannel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FtpControlChannel.data,
      qt_meta_data_FtpControlChannel,  qt_static_metacall, nullptr, nullptr}
};
