...
public:
    ...
    {
        RemoteSelector->setWindowTitle(QApplication::translate("RemoteSelector", "Available chat services", Q_NULLPTR));
        status->setText(QApplication::translate("RemoteSelector", "Scanning...", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("RemoteSelector", "Cancel", Q_NULLPTR));
    } // retranslateUi
